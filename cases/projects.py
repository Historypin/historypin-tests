...
class Projects(HPTestCase):
	...
	def test_index(self):
		...
		projects = [
			...
			['13839007-yearofthebay'			, "Year of the Bay"				, "What events, big and small, have shaped the San Francisco Bay? Share your memories."						, '13839007/type/project_image'],
			...
			['30128133-putting-art-on-the-map'	, 'Putting Art on the Map'		, 'Explore, curate and enrich the Imperial War Museums\' First World War artworks.'							, '30128133/type/project_image'],
		]
