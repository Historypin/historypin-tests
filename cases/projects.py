...
class Projects(HPTestCase):
	...
	def test_index(self):
		...
		projects = [
			...
			['%d-east-at-main-street' % ID_PROJECTS[16]	, 'East at Main Street'			, "We invite individuals and organizations to share their memories and information related to places that matter to diverse Asian Pacific Islander Americans.", '%d' % ID_PROJECTS_IMAGES[16]],
		]
