...
class Project_NPower_Play(Project_NPower):
	...
	def test_index(self):
		...
		self.assertEqual('{0}/projects/img/pid/18/type/logo/dim/600x120/'.format(URL_BASE), desc.e('img').get_attribute('src'))
		...
		self.assertEqual('{0}/project/15-remember/upload/projects/bridge/1/?subproject=18'.format(URL_BASE), button_upload.get_attribute('href'))
