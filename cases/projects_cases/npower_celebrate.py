...
class Project_NPower_Celebrate(Project_NPower):
	...
	LOCATION_URL	= '/geo:52.103536,-1.08362/zoom:8/'
	...
	def test_index(self):
		...
		self.assertEqual('{0}/projects/img/pid/21/type/logo/dim/600x120/'.format(URL_BASE), desc.e('img').get_attribute('src'))
		...
		self.assertEqual('{0}/project/15-remember/upload/projects/bridge/1/?subproject=21'.format(URL_BASE), button_upload.get_attribute('href'))
